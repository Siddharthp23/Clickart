<%-- 
    Document   : MenWear.jsp
    Created on : 06-Aug-2024, 12:48:33 pm
    Author     : HP
--%>
        ...
        <div class="container-fluid back-img mt-2">
          <div class="carousel">
            <div class="carousel-item">
                <img src="all_components/carousel-img/m1.avif" alt="Image 1">
            </div>
              <div class="carousel-item">
                <img src="all_components/carousel-img/m2.avif" alt="Image 2">
            </div>
              <div class="carousel-item">
                <img src="all_components/carousel-img/m3.avif" alt="Image 3">
            </div>
              <div class="carousel-item">
                <img src="all_components/carousel-img/m5.webp" alt="Image 3">
            </div>
        ...
        <script src="all_components/carousel.js"></script>
         ...
         <div class="container-fluid  mt-3">
             <div class="container mt-3">
                 <h3 class="text-center">Mens Wear</h3>
                    <div class="row">
                            
                            <%
                            itemDaoImpl dao = new itemDaoImpl(DBConnect.getConn()); 
                            List<Add_Items> list = dao.getMenWear();
