<%-- 
    Document   : WomenTraditional
    Created on : 05-Aug-2024, 11:25:50 pm
    Author     : HP
--%>
...
<html>
    <head>
        ...
        <title>Women Ethnics And Festives</title>
    ...
    <body style="background-color: #f5f5f5;" >
        ...
        <div class="container-fluid  mt-3">
             <div class="container mt-3">
                 <h3 class="text-center">Traditional Wears</h3>
                    <div class="row">
                            
                            <%
                            itemDaoImpl dao = new itemDaoImpl(DBConnect.getConn()); 
                            List<Add_Items> list = dao.getWomenTraditionals();
