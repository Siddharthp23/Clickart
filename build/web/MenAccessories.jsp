<%-- 
    Document   : MenAccessories
    Created on : 05-Aug-2024, 12:55:31 am
    Author     : HP
--%>
        ...
        <div class="container-fluid back-img mt-2">
          <div class="carousel">
            <div class="carousel-item">
                <img src="all_components/carousel-img/ma1.jpg" alt="Image 1">
            </div>
              <div class="carousel-item">
                <img src="all_components/carousel-img/ma2.avif" alt="Image 2">
            </div>
              <div class="carousel-item">
                <img src="all_components/carousel-img/ma3.avif" alt="Image 3">
            </div>
        ...
        <script src="all_components/carousel.js"></script>
         ...
         <div class="container-fluid  mt-3">
             <div class="container mt-3">
                 <h3 class="text-center">Men Accessories</h3>
                    <div class="row">
                            
                            <%
                            itemDaoImpl dao = new itemDaoImpl(DBConnect.getConn()); 
                            List<Add_Items> list = dao.getMenAccessories();
